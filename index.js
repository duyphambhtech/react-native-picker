...
import { StyleSheet, Modal, View, Text, Animated, Platform, Dimensions, PickerIOS
} from 'react-native'
    ...
    return (
      ...
      >
        <View style={styles.mask} >
          <Text style={{flex: 1}} onPress={() => { this.hide() }} />
        </View>
        <Animated.View style={[styles.picker, {
          elevation: this.state.pickerElevation,
          width: longSide,
          height: this.state.style.height || 270,
          ...
          <View style={[styles.pickerBox, this.state.style]}>
            ...
            <View style={[styles.pickerWrap, {height: 220, width: this.state.style.width || width}]}>
